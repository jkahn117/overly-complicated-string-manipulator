/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5456f120e572bfb8a6506c267cba90b5)
// Runtime types generated with workerd@1.20260305.0 2026-02-27 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	type UsageEventsRecord = { value: Record<string, unknown> };
	interface Env {
		TENANTS: KVNamespace;
		USAGE_METRICS: R2Bucket;
		DISPATCHER: DispatchNamespace;
		LOADER: WorkerLoader;
		ASSETS: Fetcher;
		USAGE_PIPELINE: import("cloudflare:pipelines").Pipeline<Cloudflare.UsageEventsRecord>;
		CF_ACCOUNT_ID: "9b453c382b0dcb55a9f87834b13d2883";
		CF_DISPATCH_NAMESPACE: "wfp-dynamics";
		CF_API_TOKEN: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_ACCOUNT_ID" | "CF_DISPATCH_NAMESPACE" | "CF_API_TOKEN">> {}
}
